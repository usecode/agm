import { AfterViewInit, EventEmitter, SimpleChanges, ViewContainerRef, TemplateRef, OnDestroy, ElementRef } from '@angular/core';
import { AgmMarker, GoogleMapsAPIWrapper, MarkerManager, MapsAPILoader } from '@agm/core';
export declare class AgmSnazzyInfoWindow implements AfterViewInit, OnDestroy {
    private _marker;
    private _wrapper;
    private _manager;
    private _loader;
